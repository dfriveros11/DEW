...
public class LugarDivisionesDeLugarResource {
     ...
     * @throws BusinessLogicException
     * 
     * En caso de no existir el id de la Division se retorna un 404 not
     * found.
     * 
    ...
    public DivisionDeLugarDetailDTO getDivisionLugar(@PathParam("idLugar") Long id, @PathParam("idDivision") Long idDivision) throws BusinessLogicException {
        ...
        for(DivisionDeLugarEntity d : divisiones) if(d.getId().equals(idDivision)) division = d;
     ...
     * @return la division que fue creada para la relacion con el lugar en objeto json DTO.
    ...
    /**
     * PUT para crear una relacion division lugar con uno ya existente en el sistema.
     * http://localhost:8080/nboletas-web/api/lugares/idLugar/divisiones/idDivision
     *
     * @return la division que fue creada para la relacion con el lugar en objeto json DTO.
     * @throws BusinessLogicException
    ...
    /**
     * DELETE para eliminar una relacion division-lugar ya existente en el sistema.
     * http://localhost:8080/nboletas-web/api/lugares/idLugar/divisiones/idDivision
     *
